...
class SBLHrEmployee(models.Model):
    ...
    sbl_hide_pos_action_transfer_course = fields.Boolean(
        string='Hide Transfer Course Button',
        help='If checked, the Transfer Course button will be hidden in the Actions popup.',
        default=False,
    )
    ...
    def _load_pos_data_fields(self, config):
        ...
        return fields + [
            ...
            'sbl_hide_pos_action_transfer_merge', 'sbl_hide_pos_action_transfer_course',
            'sbl_hide_pos_action_bill', 'sbl_hide_pos_action_edit_order_name',
            'sbl_hide_restaurant_order_button', 'sbl_hide_pos_switch_floor_view',
            'sbl_disabled_floor_ids'
        ]
